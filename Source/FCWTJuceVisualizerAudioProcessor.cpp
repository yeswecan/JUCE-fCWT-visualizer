...
void FCWTJuceVisualizerAudioProcessor::processBlock(AudioBuffer<float>& buffer, MidiBuffer& midiMessages) {
...
//
//#ifndef JucePlugin_PreferredChannelConfigurations
//bool FCWTJuceVisualizerAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
//{
//  #if JucePlugin_IsMidiEffect
